...
@WebServlet("/ConfiguracionTablet")
public class ConfiguracionTablet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.getRequestDispatcher("/configTablets.jsp").forward(request, response);
		} catch (Exception e) {
