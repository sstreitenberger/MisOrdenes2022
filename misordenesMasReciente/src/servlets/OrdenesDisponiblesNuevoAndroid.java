...
@WebServlet("/OrdenesDisponiblesNuevoAndroid")
public class OrdenesDisponiblesNuevoAndroid extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//	String pzona = request.getParameter("zona");
			...
			ArrayList<Orden> ordenes = go.TraerOrdenes(zonadisp);
				...
				if (TimeUnit.SECONDS.convert(diff, TimeUnit.MILLISECONDS) > alertA) {
					if (TimeUnit.SECONDS.convert(diff, TimeUnit.MILLISECONDS) > alertB) {
						if (TimeUnit.SECONDS.convert(diff, TimeUnit.MILLISECONDS) > alertC) {
							...
							if (ordenes.get(i).getZona().equals(zonadisp.getZ1().toString()) || ordenes.get(i).getZona().equals(zonadisp.getZ2().toString()) || ordenes.get(i).getZona().equals(zonadisp.getZ3().toString()) || ordenes.get(i).getZona().equals(zonadisp.getZ4().toString())) {
								
							response.getWriter()
									.append("<div class=\"round-button col-xs-1\" onclick=\"enviar("
											+ ordenes.get(i).getId() + ")\" id=\"" + ordenes.get(i).getId() + "\">"
											+ "<div class=\"round-button-circle-alertC-and\">"
											+ "<a class=\"round-button-and\">"
						...
						} else {if (ordenes.get(i).getZona().equals(zonadisp.getZ1().toString()) || ordenes.get(i).getZona().equals(zonadisp.getZ2().toString()) || ordenes.get(i).getZona().equals(zonadisp.getZ3().toString()) || ordenes.get(i).getZona().equals(zonadisp.getZ4().toString())) {

							response.getWriter()
									.append("<div class=\"round-button col-xs-1\" onclick=\"enviar("
											+ ordenes.get(i).getId() + ")\" id=\"" + ordenes.get(i).getId() + "\">"
											+ "<div class=\"round-button-circle-alertB-and\">"
											+ "<a class=\"round-button-and\">" 
						...
						response.getWriter()
								.append("<div class=\"round-button col-xs-1\" onclick=\"enviar("
										+ ordenes.get(i).getId() + ")\" id=\"" + ordenes.get(i).getId() + "\">"
										+ "<div class=\"round-button-circle-alertA-and\">" + "<a class=\"round-button-and\">"
					...
					response.getWriter()
							.append("<div class=\"round-button col-xs-1\" onclick=\"enviar(" + ordenes.get(i).getId()
									+ ")\" id=\"" + ordenes.get(i).getId() + "\">"
									+ "<div class=\"round-button-circle-and\">" + "<a class=\"round-button-and\">"
