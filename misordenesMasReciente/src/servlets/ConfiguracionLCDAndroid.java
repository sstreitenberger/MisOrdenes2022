...
@WebServlet("/ConfiguracionLCDAndroid")
public class ConfiguracionLCDAndroid extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.getRequestDispatcher("/configLCDsAndroid.jsp").forward(request, response);
		} catch (Exception e) {
