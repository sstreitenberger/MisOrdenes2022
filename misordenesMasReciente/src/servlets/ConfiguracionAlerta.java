...
@WebServlet("/ConfiguracionAlerta")
public class ConfiguracionAlerta extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.getRequestDispatcher("/configAlerta.jsp").forward(request, response);
		} catch (Exception e) {
